...
import { getCourses, createCourse, getAllFeedback, getAnalytics } from '../utils/storage';
...
import { FaPlusCircle, FaChartLine, FaClipboardList, FaHome, FaBookOpen, FaUserCircle, FaBell, FaSignOutAlt, FaSun, FaMoon, FaBars, FaGraduationCap, FaCheckCircle, FaUsers, FaChartPie, FaCog } from 'react-icons/fa';
...
const AdminDashboard = () => {
    ...
    const loadData = () => {
        const c = getCourses();
        const f = getAllFeedback();

        setCourses(c);
        setAllFeedback(f);
        setAnalytics(getAnalytics());

        // 1. Calculate Rating Distribution (1-5 stars combining course & instructor & content)
        ...
        // 2. Calculate Recommendation / Sentiment Breakdown
        // Logic: 4-5 = Positive, 3 = Neutral, 1-2 = Constructive
        ...
        // Generate AI Insight / Improvement Summary
    ...
    return (
        <div className="d-flex min-vh-100 bg-transparent flex-column flex-lg-row">
            ...
            <div className="d-lg-none d-flex justify-content-between align-items-center p-3 border-bottom bg-white premium-hover-lift" style={{ backgroundColor: 'var(--card-bg)' }}>
                <h5 className="mb-0 fw-bold d-flex align-items-center"><FaChartPie className="me-2 text-primary" />Teacher</h5>
            ...
            <div className={`sidebar bg-white border-end flex-column ${sidebarOpen ? 'd-flex position-fixed' : 'd-none d-lg-flex'}`} style={{ width: '280px', height: '100vh', top: 0, left: 0, zIndex: 1050, transition: 'transform 0.3s ease', backgroundColor: 'var(--card-bg)' }}>
                <div className="p-4 border-bottom d-none d-lg-block">
                    <div className="text-decoration-none text-dark d-flex align-items-center">
                        <h5 className="fw-bolder mb-0 text-primary d-flex align-items-center"><FaChartPie className="me-2 fs-3" /> Teacher</h5>
                    </div>
                </div>
            ...
            <div className="flex-grow-1 d-flex flex-column w-100 overflow-hidden" style={{ backgroundColor: 'var(--bg-main)' }}>
                ...
                <nav className="navbar navbar-expand bg-white border-bottom px-4 py-3 shadow-sm" style={{ backgroundColor: 'var(--card-bg)' }}>
                    <div className="d-flex align-items-center mb-2 mb-md-0 d-none d-md-flex w-100 justify-content-between">
                        <div className="input-group" style={{ maxWidth: '400px' }}>
                            ...
                            <input type="text" className="form-control bg-light border-0" placeholder="Search analytics or feedback..." />
                        </div>
                        <ul className="navbar-nav align-items-center">
                            ...
                            <li className="nav-item dropdown d-flex align-items-center">
                                <div className="d-flex flex-column text-end me-3 d-none d-sm-flex">
                                    ...
                                    <span className="text-danger small fw-bold lh-sm text-capitalize"> Teacher{user.role}</span>
                                </div>
                ...
                <div className="container-fluid p-4 p-md-5 overflow-auto flex-grow-1">
                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-8 text-white">
                                    <div className="d-flex align-items-center mb-2">
                                        <span className="badge bg-danger bg-opacity-75 text-white px-3 py-2 rounded-pill fw-bold border border-light border-opacity-25 me-3">Department: Engineering</span>
                    ...
                    <div className="row g-4">
                        {/* Left Column: Create Course & Top Courses */}
                        <div className="col-lg-5 d-flex flex-column gap-4">
                            ...
                            <div className="card border-0 shadow-sm rounded-4">
                                ...
                                <div className="card-body p-4">
                                    {message && <div className="alert alert-success py-2 shadow-sm rounded-3">{message}</div>}
                                    <form onSubmit={handleCreateCourse}>
                                        ...
                                        <button type="submit" className="btn btn-primary w-100 py-2 fw-bold rounded-pill hover-lift shadow-sm">Initialize Course <FaPlusCircle className="ms-1" /></button>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-7">
                            <div className="card border-0 shadow-sm h-100 rounded-4">
                                <div className="card-header bg-white border-bottom pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
                                    ...
                                    <span className="badge bg-light text-primary border rounded-pill px-3 py-2 fw-bold">{allFeedback.length} Reports</span>
                                </div>
