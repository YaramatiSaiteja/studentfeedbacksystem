...
import { getCourses, submitFeedback } from '../utils/storage';
...
const SubmitFeedback = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        try {
            submitFeedback({ courseId: course.id, studentId: user.id, ...feedback });
            setSubmitted(true);
            setTimeout(() => {
                navigate('/student/dashboard');
            }, 3000);
        ...
        <div className="d-flex min-vh-100 flex-column flex-lg-row" style={{ backgroundColor: '#f1f5f9' }}>
            ...
            >
                ...
                <div className="p-3 border-top">
                    ...
                    <button onClick={handleLogout} className="btn btn-light w-100 d-flex align-items-center justify-content-center fw-bold border">
