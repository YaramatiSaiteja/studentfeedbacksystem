  ...
  return (
    <div>
      ...
      <section className="py-5" style={{ backgroundColor: 'var(--bg-main)' }}>
        <div className="container py-4">
          ...
          <div className="text-center mb-5">
            <h2 className="fw-bold mb-2" style={{ color: 'var(--text-main)', fontSize: '1.75rem' }}>Why Choose Us</h2>
            <p className="text-muted mb-0" style={{ fontSize: '0.95rem' }}>Simple, powerful tools for better education.</p>
          </div>
            ...
            {[
              ...
              <div className="col-md-4" key={f.title}>
                <div
                  ...
                  style={{ borderRadius: 14, border: '1px solid var(--card-border)', transition: 'all 0.2s ease', cursor: 'default' }}
                ...
                >
                  ...
                  <h6 className="fw-bold mb-2" style={{ color: 'var(--text-main)' }}>{f.title}</h6>
                  <p className="text-muted mb-0" style={{ fontSize: '0.85rem', lineHeight: 1.55 }}>{f.text}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      >
        ...
        <div
          className="position-absolute top-0 start-0 w-100 h-100"
          style={{ background: isDarkMode ? 'rgba(2,6,23,0.82)' : 'rgba(240,247,255,0.93)' }}
        />

        <div className="container py-4 position-relative" style={{ zIndex: 1 }}>

          <div className="text-center mb-5">
            <h2 className="fw-bold mb-2" style={{ color: 'var(--text-main)', fontSize: '1.75rem' }}>Choose Your Path</h2>
            <p className="text-muted mb-0" style={{ fontSize: '0.95rem' }}>Tailored tools for every user.</p>
          </div>
            ...
            {[
              ...
              <div className="col-lg-4 col-md-6" key={p.title}>
                ...
                >
                  ...
                  <h6 className="fw-bold mb-2" style={{ color: 'var(--text-main)', fontSize: '1rem' }}>{p.title}</h6>
                  <p className="text-muted mb-0" style={{ fontSize: '0.85rem', lineHeight: 1.55 }}>{p.text}</p>
                </div>
              </div>
            ))}
          </div>
